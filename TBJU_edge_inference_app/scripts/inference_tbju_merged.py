...
def parse_args():
    ...
    p.add_argument('--save_dir', type=Path, default=base / 'results_merged')
    p.add_argument('--yolo_model', type=Path, default=base / 'merged_yolov8.rknn')
    p.add_argument('--ocr_model', type=Path, default=base / 'rec_tbju.rknn')
    p.add_argument('--dict', type=Path, default=base / 'ppocr_keys_v1.txt')
    p.add_argument('--classes', type=Path, default=base / 'merged_classes.txt')
